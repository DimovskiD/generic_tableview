 ...
 * @property type - type of the row that should be used for this element. Implementation of [ActionType]. Defaults to [GenericRowType]
...
open class GenericListElement(val columnsMap : Map<GenericView, Boolean>, val type : ActionType = GenericRowType, val actionTextRes : Int? = null, val actionIconRes : Int? = null)